            ...
            <form  action="{{route('user.deposit.insert')}}" method="post">
                ...
                <div class="card custom--card">
                    <div class="card-header">
                        <h5 class="m-0">@lang('Deposit Money')</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mt-3 preview-details d-none">
                            <ul class="list-group">
                                <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <span><span class="min fw-bold">0</span> {{__($general->cur_sym)}} - <span class="max fw-bold">0</span> {{__($general->cur_sym)}}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>@lang('Charge')</span>
                                    <span><span class="charge fw-bold">0</span> {{__($general->cur_sym)}}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span>@lang('Payable')</span> <span><span class="payable fw-bold"> 0</span> {{__($general->cur_sym)}}</span>
                                </li>
