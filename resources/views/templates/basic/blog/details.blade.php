          ...
          <div class="sidebar">
            <div class="widget">
              ...
              <li class="small-post">
                  ...
                  <div class="small-post__content">
                    <h5 class="post__title"><a href="{{ route('blog.details', [slug($recent->data_values->title), $recent->id]) }}">{{ __($recent->data_values->title) }}</a></h5>
                  </div>
                </li>
                @endforeach
            ...
            <div class="widget">
              ...
              <li class="small-post">
                  ...
                  <div class="small-post__content">
                    <h5 class="post__title"><a href="{{ route('blog.details', [slug($view->data_values->title), $view->id]) }}">{{ __($view->data_values->title) }}</a></h5>
                  </div>
                </li>
                @endforeach
              </ul><!-- small-post-list end -->
