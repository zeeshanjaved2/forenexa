                        ...
                        <div class="payment-method-item">
                            <div class="payment-method-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card border--primary mb-2">
                                            <h5 class="card-header bg--primary">@lang('Withrwal limit')</h5>
                                            <div class="card-body">
                                                <div class="form-group">

                                                    <label>@lang('Refferls limit')</label>
                                                    <div class="input-group">
                                                        <input type="any" step="any" class="form-control" name="ref_limit" value="{{ old('ref_limit') }}" required/>
                                                       </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="payment-method-item">
                            <div class="payment-method-body">
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-lg-6">
                                        <div class="card border--primary mb-2">
                                            <h5 class="card-header bg--primary">@lang('Withdrawal Limit')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label>@lang('Referrals Limit')</label>
                                                    <input type="number" step="any" class="form-control" name="ref_limit" value="{{ old('ref_limit') }}" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div> --}}
                                ...
                                <div class="col-lg-12">
                                    <div class="card border--primary mt-3">
                                        <div class="card-header bg--primary d-flex justify-content-between">
                                            <h5 class="text-white">@lang('User Data')</h5>
                                            <button type="button" class="btn btn-sm btn-outline-light form-generate-btn"> <i class="la la-fw la-plus"></i>@lang('Add New')</button>
                                        </div>
                                        <div class="card-body">
