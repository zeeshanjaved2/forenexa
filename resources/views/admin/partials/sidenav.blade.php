    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                {{-- <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.ptcreport*', 3) }}">
                        <i class="menu-icon las la-flag"></i>
                        <span class="menu-title">@lang('PTC Reports')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.ptcreport*', 2) }}">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.ptcreport.type') }}">
                                <a href="{{ route('admin.ptcreport.type') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Report Type')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.ptcreport.logs') }}">
                                <a href="{{ route('admin.ptcreport.logs') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.socialite.credentials') }}">
                    <a href="{{ route('admin.socialite.credentials') }}" class="nav-link">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.setting.notification*', 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.notification.add') }} ">
                                <a href="{{ route('admin.notification.add') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('User Notification')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
