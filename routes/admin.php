...
Route::middleware('admin')->group(function () {
    ...
    Route::controller(NotificationController::class)->group(function () {
        Route::get('/notification', 'UserNotiGet')->name('notification.add');
        Route::post('/notification/store', 'UserNotiStore')->name('notification.store');
    });
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        Route::post('social/credentials/status/{key}', 'updateSocialiteCredentialStatus')->name('socialite.credentials.status.update');
