<div class="sidebar bg--dark">
    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar__main-logo"><img src="<?php echo e(siteLogo()); ?>" alt="<?php echo app('translator')->get('image'); ?>"></a>
        </div>
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item <?php echo e(menuActive('admin.socialite.credentials')); ?>">
                    <a href="<?php echo e(route('admin.socialite.credentials')); ?>" class="nav-link">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu <?php echo e(menuActive('admin.setting.notification*', 2)); ?> ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item <?php echo e(menuActive('admin.notification.add')); ?> ">
                                <a href="<?php echo e(route('admin.notification.add')); ?>" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title"><?php echo app('translator')->get('User Notification'); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\Laravel Project\ui-ads-new\resources\views/admin/partials/sidenav.blade.php ENDPATH**/ ?>