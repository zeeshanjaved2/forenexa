            ...
            <div class="col-lg-6">
                <div class="card custom--card">
                    <div class="card-header">
                        <h5 class="m-0"><?php echo app('translator')->get('Withdraw Money'); ?></h5>
                    </div>
                    <div class="card-body">
                        <form class="dashboard-form" action="<?php echo e(route('user.withdraw.money')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make($activeTemplate.'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\ui-ads-new\resources\views/templates/ptc_prime/user/withdraw/methods.blade.php ENDPATH**/ ?>